...
You open Copilot Chat (or Claude Code), select the Dev-IQ agent, and type `/`. You get 31 skills covering your full delivery loop.
...
*Dev.IQ Agent Pack v0.12.0 · 31 skills · GitHub Copilot Chat + Claude Code*
