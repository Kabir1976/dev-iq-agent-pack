...
- 31 skills cover the developer lifecycle: requirements, design, development,
...
| `.github/skills/` | All 31 DI skills — Copilot Chat reads them from this workspace path. |
...
31 skills. Behavior varies by platform:
...
| Version | Notes |
|---------|-------|
| 0.12.0 | 31 skills. 4 new DESIGN/QUALITY skills added: `review-naming-conventions`, `review-test-coverage`, `generate-changelog`, `review-error-handling`. Anti-rationalization tables on all skills. |
